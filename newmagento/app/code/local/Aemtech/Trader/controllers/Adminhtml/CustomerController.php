...
class Aemtech_Trader_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController
{
    ...
    public function saveAction()
    {
        ...
        if($data){
            ...
            try{
                ...
                if(isset($data['account']['fromdd'])){
                    Mage::getSingleton('adminhtml/session')->addSuccess(
                            Mage::helper('adminhtml')->__('The Trader has been saved.')
                    );
                } else{
                    Mage::getSingleton('adminhtml/session')->addSuccess(
        ...
        if(isset($data['account']['fromdd'])){
            $url = $this->getUrl('adminhtml/trader');
    ...
    public function editAction()
    {
        ...
        $params = $this->getRequest()->getParams('fromdd');
        if(isset($params['fromdd']) && $params['fromdd'] == "true"){
            $this->_title($customer->getId() ? $customer->getName() : $this->__('New Trader'));
        } else{
