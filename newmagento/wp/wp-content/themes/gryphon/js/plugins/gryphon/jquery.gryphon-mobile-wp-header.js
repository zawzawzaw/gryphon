...
(function ($) {
  ...
  ///////////////////////////////
  // GryphonMobileWPHeader Class //
  ///////////////////////////////

  function GryphonMobileWPHeader(elem, settings) {
    this.element = $(elem);
  ...
  GryphonMobileWPHeader.prototype = {
  ...
  $.fn['gryphon_mobile_wp_header'] = function (settings) {
    return this.each(function () {
      // check for instance of plugin in object
      if (!$.data(this, 'gryphon_mobile_wp_header')) {
        $.data(this, 'gryphon_mobile_wp_header', new GryphonMobileWPHeader(this, settings));
      }
    });
  };
