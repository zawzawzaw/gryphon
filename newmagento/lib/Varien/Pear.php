...
if (defined('COMPILER_INCLUDE_PATH')) {
       echo '
<h3 style="font:18px/1.5em Arial, Helvetica, sans-serif; ">
Connection manager can be used only if <b style="color:red">Compilation</b> is disabled.<br>
Please disable Compilation in <p style="color:red">System > Tools > Compilation</p>
               <a style="color:#2976c9" href="'.Mage::getUrl('compiler/process').'">Back to Admin panel</a></h3>';
       exit;
}
